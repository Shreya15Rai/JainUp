                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">View All Gallery Images</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="card p-5">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">All type of Gallery Images</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card">
                                    <table class="table text-nowrap mb-0 table-centered table-hover">
                                        ...
                                        <?php
                                            $query="SELECT * from tbl_gallery ORDER BY KeyCode Desc";
                                            $result = mysqli_query($conn,$query);
                                            $a=0;
                                            while($data = mysqli_fetch_array($result))
                                            {                               
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="p-1 border"><a onClick="javascript: return confirm('Are you Sure Want To Delete');" href="AdminBack.php?action=DeleteGallery&key=<?php echo $data['KeyCode'];?>" ><i class=" fas fa-trash"></i></a></span>
                                                    <span class="p-1 border"><a href="detail_gallery.php?key=<?php echo $data['KeyCode']; ?>"><i class="fas fa-eye"></i></a></span>
                                                </td>
                                            </tr>                                            
                                        </tbody>
                                        <?php
