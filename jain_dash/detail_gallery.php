...
$key_code=$_GET["key"];
$query="SELECT * from tbl_gallery where KeyCode=$key_code";
$result = mysqli_query($conn,$query);
$a=0;
while($data = mysqli_fetch_array($result))
{ 
...
<head>
    ...
    <title>Dashboard | Jain Temple</title>
</head>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Details Of the Gallery File</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="card p-5">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">Details of the <b><?php echo $img_title; ?></b></h4>  
                                <h4><a href="view_gallery.php" >Back to Gallery files List</a> </h4>                              
                            <!-- table  -->                            
                        </div>
                        <div class="row p-5">
                            <div class="col-lg-8">
                                <?php 
                                    if($img_file==" "){
                                        ?>
                                        <img src="assets/images/background/no_avatar.avif" alt="Gallery" class="w-50">No File                                                    
                                    <?php }else{
                                        ?>
                                        <a href="assets/images/background/<?php echo $img_file; ?>" target="_blank"><img src="assets/images/background/<?php echo $img_file; ?>" alt="<?php echo $img_title; ?>" class="w-100"> <?php echo $img_file; ?>  </a>                                                                                       
                                    <?php }
                                ?>
                            </div>
