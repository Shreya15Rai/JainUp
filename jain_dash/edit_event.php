...
$key_code=$_GET["key"];
$query="SELECT * from tbl_event WHERE Keycode = '$key_code' ";
        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Update Event</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="card p-5">
                            <form method="POST" action="AdminBack.php?action=EditEvent&key=<?php echo $key_code; ?>" enctype="multipart/form-data">
                            <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="textInput">Event Name</label>
                                            <input type="text" id="Event_name" class="form-control"
                                                placeholder="Event name " name="Event_name" value="<?php echo $Name_event; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="Date" class="form-control"
                                                placeholder="Date" name="Date" value="<?php echo $event_date; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="Description" class="form-control"
                                                placeholder="Event Description" name="Description"><?php echo $Description; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
