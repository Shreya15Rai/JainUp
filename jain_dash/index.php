                ...
                <div class="container-fluid mt-n22 ">
                    ...
                    mb-3">
                      ...
                      rounded-2">
                                    ...
                                    <div class="lh-1">
                                    <?php
                                            $query=mysqli_query($conn,"SELECT COUNT(*) AS tot_event FROM tbl_event");
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12 col-12 mb-5">
                            ...
                            <div class="card h-100 card-lift">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="lh-1">
                                    <?php
                                            $query=mysqli_query($conn,"SELECT COUNT(*) AS tot_blog FROM tbl_blogs");
                                            $result = mysqli_fetch_assoc($query);                                                                          
                                        ?> 
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-card">
                                        ...
                                        <?php
                                        $query="SELECT * from tbl_event LIMIT 5";
                                        $result = mysqli_query($conn,$query);
                                        $a=0;
                                        while($data = mysqli_fetch_array($result))
                                        {                               
