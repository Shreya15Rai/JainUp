        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Add Gallery</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="card p-5">
                        <form method="POST" action="AdminBack.php?action=add_gallery" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="textInput">Image Title <span class="text-danger">*</span></label>
                                            <input type="text" id="gallery_title" class="form-control"
                                                placeholder="Image Title " name="gallery_title" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="textInput">Upload File</label>
                                            <input type="file" id="fileDoc" class="form-control"
                                                placeholder="Image" name="fileDoc">
                                                <label for="">Only jpg, gif, and png files allowed to a max size of 2 MB</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
